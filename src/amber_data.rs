pub(crate) const AMINO: &str = include_str!("../data/amber/lib/amino12.lib");
pub(crate) const AMINO_N: &str = include_str!("../data/amber/lib/aminont12.lib");
pub(crate) const AMINO_C: &str = include_str!("../data/amber/lib/aminoct12.lib");
pub(crate) const GLYCAM_AMINO: &str = include_str!("../data/amber/lib/GLYCAM_amino_06j_12SB.lib");
pub(crate) const GLYCAM_AMINO_N: &str =
